module.exports = function () {
    ...
    var config = {
        ...
        rxjsCompl: base.node_modules + "rxjs/Rx.js",
        jasminejs: base.node_modules + "jasmine-core/lib/jasmine-core/*.*",
        intljs: base.node_modules + "intl/dist/Intl.complete.js",
        classlistjs: base.node_modules + "classlist.js/classlist.min.js",
        html5history: base.node_modules + "html5-history-api/history.min.js"
    };
